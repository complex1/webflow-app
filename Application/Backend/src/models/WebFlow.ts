...
interface WebFlowCreationAttributes
  extends Optional<WebFlowAttributes, 'id' | 'createdAt' | 'updatedAt' | 'publicShareEnabled' | 'publicShareToken'> {}
...
class WebFlow extends Model<WebFlowAttributes, WebFlowCreationAttributes> implements WebFlowAttributes {
  ...
  public publicShareEnabled!: boolean;
  public publicShareToken!: string | null;
...
WebFlow.init(
  {
    ...
    publicShareEnabled: {
      ...
      allowNull: false,
      defaultValue: false,
      field: 'public_share_enabled',
    },
    publicShareToken: {
      type: DataTypes.STRING(64),
      allowNull: true,
      unique: true,
      field: 'public_share_token',
    },
  },
  {
    sequelize,
